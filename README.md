...
The `rundeck-buildpack` is a [Cloud Foundry](https://www.cloudfoundry.org/) buildpack for running [SonarQube](https://www.sonarqube.org/).
It installs java and rundeck and uses the provided sonar.properties file for configuration.
